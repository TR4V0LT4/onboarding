                            ...
                            <React.Fragment key={product.id}>
                                <tr className={`text-[#344051] text-[13px]/[13px] font-medium ${index % 2 === 0 ? 'bg-white' : 'bg-[#CCE0FF40]'} ${editingProductId === product.id ? "border border-b-0 border-gray-300" : ""}`}>
                                  ...
                                  {product.ppv.length > 1 ? (
                                    <td className="p-4 font-normal whitespace-nowrap ">
                                      <Select defaultValue={product.ppv[0].toString()} onValueChange={(value) => handleUpdateProduct({ ...product, selected_ppv: parseFloat(value) })}>
                                        <SelectTrigger className="gap-x-1 h-8 text-[13px]/[13px] font-medium">
                                          <SelectValue />
                                  ...
                                  <td className="p-4 whitespace-nowrap flex space-x-2">
                                    <Button className="bg-white p-2 hover:bg-slate-200" onClick={() => handleRemoveFromCart(product.id)}>
                                    ...
                                    <Button className="bg-white p-2 flex items-center justify-center hover:bg-slate-200" onClick={() => handleEdit(product.id)}>
                                      <EditIcon className="w-5 h-5 text-blue-500 ml-1" />
                                    </Button>
                                  </td>
                                </tr>
                                {editingProductId === product.id && (
                                  <tr className={`text-[#344051] text-[13px]/[13px] font-medium ${index % 2 === 0 ? 'bg-white' : 'bg-[#CCE0FF40]'} ${editingProductId === product.id ? 'border border-blue-500' : ''}`}>
                                      ...
                                      <div className="flex justify-between flex-wrap w-full gap-y-4 gap-x-2">
                                        <div className="flex flex-col justify-start gap-y-1">
                                          ...
                                          <Input
                                            ...
                                            className="w-20 h-8 outline-none ring-0 focus:ring-0 focus-visible:ring-0"
                                          />
                                        </div>
                                        <div className="flex flex-col justify-start gap-y-1">
                                          ...
                                          >
                                            <SelectTrigger className="gap-x-2 h-8 min-w-32">
                                        ...
                                        <Button onClick={() => handleSave(product)} className="self-end h-8 bg-[#3A8DFF] hover:bg-blue-400 rounded-[8px]">
                                          Applique la remise
                                        </Button>
                                        <div className="flex flex-col justify-start gap-y-1">
